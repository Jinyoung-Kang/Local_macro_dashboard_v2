...
| 메뉴 | 경로 | 내용 |
|---|---|---|
| 📊 거시경제 매크로 지표 | `/macro` | **📋 전체 대시보드 원본 데이터 보기/복사**(상단), **자동 갱신 간격 선택**(10초~30분·끄기 — 4-12), 환율·국채·원자재·지수, 10Y−2Y·30Y−2Y 금리차(공식 확정치 + 스크래핑 시세 병기), 신용·변동성 리스크, **심화 지표 6종** (차트 기간 1~10년 선택) |
...
보입니다. **환율을 모르면 원화를 적지 않습니다** — 기본 환율(예: 1,300원)로
지어내면 틀린 금액을 사실처럼 보여 주게 됩니다.
